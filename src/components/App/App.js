...
import song2 from "../../assets/audio/Billie Eilish  Six Feet Under.mp3";
import song3 from "../../assets/audio/Confetti  Ghost.mp3"
import song4 from "../../assets/audio/DHARIA  Sugar  Brownies.mp3"
import song5 from "../../assets/audio/Jony Love Your Voice.mp3"

// Import song cover images
import song1Img from "../../assets/Besomorph  Silent Child  IDGAF.png";
import song2Img from "../../assets/Billie Eilish  Six Feet Under.png";
import song3Img from "../../assets/Confetti  Ghost.png";
import song4Img from "../../assets/DHARIA  Sugar  Brownies.png";
import song5Img from "../../assets/Jony Love Your Voice.png";

// Import wallpapers
import AudioTapes from "../../assets/AudioTapes.png"
...
class App extends Component {
   ...
   render() {
      const { 
         audio, active, currentMenu, 
         menuItems, musicItems, songItems, 
         playing, songIndex, theme, songUrl, 
         songImgUrl, wheelColor, wallpaper, 
         wallpaperItems, noty, notifyText 
      } = this.state;
      ...
      return (
         <div className="App">
            <KnowMore/>
            <Case 
               songIndex={songIndex} active={active} menuItems={menuItems} musicItems={musicItems} 
               currentMenu={currentMenu} changeMenuForward={this.changeMenuForward} 
               changeMenuBackward={this.changeMenuBackward} updateActiveMenu={this.updateActiveMenu} 
               togglePlayPause={this.togglePlayPause} songItems={songItems} playing={playing} 
               theme={theme} audio={audio} songUrl={songUrl} songImgUrl={songImgUrl} 
               seekSongForward={this.seekSongForward} seekSongReverse={this.seekSongReverse} 
               wheelColor={wheelColor} wallpaper={wallpaper} wallpaperItems={wallpaperItems} 
               noty={noty} setNoty={this.setNoty} notifyText={notifyText}
            />
         </div>
      );
   }
